...
class bookLandForm(tk.Toplevel):
    def __init__(self, master, db_manager, user_id, refresh_callback, on_close_callback, parent_icon_loader=None, window_icon_name="book_land.png"):
    ...
    def _create_widgets(self, parent_icon_loader):
        ...
        self.btn_installments = ttk.Button(payment_options_frame, text="Instalments", command=self._open_installment_booking_window, style='Yellow.TButton')
    ...
    def _populate_property_list(self, search_query="", min_size=None, max_size=None):
        """
        Populates the property listbox with properties, optionally filtered.
        """
        self.property_listbox.delete(0, tk.END)

        # Retrieve all available properties without project details as requested.
